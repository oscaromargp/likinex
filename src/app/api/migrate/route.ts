...
DO $$ BEGIN ALTER TABLE transactions ADD COLUMN source_entity VARCHAR(255); EXCEPTION WHEN duplicate_column THEN null; END $$;
DO $$ BEGIN ALTER TABLE transactions ADD COLUMN destination_entity VARCHAR(255); EXCEPTION WHEN duplicate_column THEN null; END $$;
DO $$ BEGIN ALTER TABLE transactions ADD COLUMN recurrence_days_of_month INTEGER[]; EXCEPTION WHEN duplicate_column THEN null; END $$;
DO $$ BEGIN ALTER TABLE transactions ADD COLUMN recurrence_end_date DATE; EXCEPTION WHEN duplicate_column THEN null; END $$;
DO $$ BEGIN ALTER TABLE transactions ADD COLUMN recurrence_count INTEGER; EXCEPTION WHEN duplicate_column THEN null; END $$;
